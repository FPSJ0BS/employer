  ...
  return (
    <div className="absolute h-full w-full bg-gray-600 bg-opacity-80 z-50 ">
      <div className=" h-[100%] w-[100%] flex justify-center items-center z-50">
        <div className=" bg-white min-h-[400px] w-[35%] rounded-lg relative z-50 p-5">
          <button onClick={() => setRedirect()} className="bg-red-500 absolute left-2 top-1 px-4 text-white  border-2 rounded-lg font-semibold">
            Skip
          </button>
