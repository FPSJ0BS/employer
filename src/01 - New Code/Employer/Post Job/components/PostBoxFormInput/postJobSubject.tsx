...
import { SubCategoryInterface } from "../../../Redux/EmployerSlice";

export const PostJobSubject = () => {
  const { subCategoryData, employerPostJob } = useSelector(
  ...
  return (
    <div className=" relative  sm:w-[100%] w-[250px] ">
      <label
        htmlFor="EmployerPostJobSubject"
      ...
      <div className="relative">
        <input
          ...
          disabled={employerPostJob.catID === null}
          autoComplete="off"
          required
          ref={inputRef}
          type="text"
          id="EmployerPostJobSubject"
          name="EmployerPostJobSubject"
          value={inputValue}
