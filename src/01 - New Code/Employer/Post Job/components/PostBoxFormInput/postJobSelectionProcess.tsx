...
import { SelectionProcessInterface } from "../../../Redux/EmployerSlice";

export const PostJobSelectionProcess = () => {
  const { selectionProcessData } = useSelector((state: any) => state.employerSliceNew);
  ...
  return (
    <div className=" relative  sm:w-[100%] w-[250px] ">
      <label
        htmlFor="EmployerPostJobSelectionProcess"
      ...
      <div className="relative">
        ...
        placeholder="Choose Process..."
          ref={inputRef}
          type="text"
          id="EmployerPostJobSelectionProcess"
