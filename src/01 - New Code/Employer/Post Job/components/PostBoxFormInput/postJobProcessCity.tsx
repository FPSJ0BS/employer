...
export const PostJobProcessCity = () => {
  const { employerPostJob, PostJobPreFillDataProcessCity } = useSelector(
  ...
  return (
    <div className=" relative  sm:w-[100%] w-[250px]">
      <label
        htmlFor="EmployerPostJobProcessCity"
      ...
      <div className="relative">
        ...
        autoComplete="off"
          disabled={employerPostJob.process_state.trim() === ""}

          ref={inputRef}
          type="text"
          id="EmployerPostJobProcessCity"
          name="EmployerPostJobProcessCity"
          value={inputValue}
