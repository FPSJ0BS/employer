...
import { QualificationInterface } from "../../../Redux/EmployerSlice";

export const PostJobQualification = () => {
  ...
  return (
    <div className=" relative  sm:w-[100%] w-[250px] ">
      <label
        htmlFor="EmployerPostJobQualification"
      ...
      <div className="relative">
        <input
          ...
          ref={inputRef}
          type="text"
          id="EmployerPostJobQualification"
          name="EmployerPostJobQualification"
          value={inputValue}
