...
import { BASE_URL, getjobDetail } from "../../../../../api/apiAxios.ts";
import { useParams } from "react-router-dom";
import { useSelector, useDispatch } from "react-redux";

import { PaginationC } from "./ui/PaginationC.tsx";
import {
  clearAllFilters,
...
import { editEmployerEditJob } from "../../../Redux/EmployerEditJob.tsx";
...
export const SuggestedProfile = () => {
  ...
  const { employerEditJob } = useSelector((state) => state.employerEditJob);
  const {
