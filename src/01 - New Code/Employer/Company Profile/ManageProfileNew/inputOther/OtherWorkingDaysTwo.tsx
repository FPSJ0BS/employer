...
export const OtherWorkingDaysTwo = () => {
  ...
  useEffect(() => {
    ...
    setYearsArray(generateDaysArray());

  }, []);

  useEffect(() => {
    if (employerManageProfileFields?.working_days) {
      setInputValue(employerManageProfileFields?.working_days);
    }
  }, [employerManageProfileFields?.working_days]);
    ...
    const handleClickOutside = (e: MouseEvent) => {
      ...
      if (
        ...
        if (!isSelect) {
          ...
          const currentBrandLevel = employerManageProfileFields?.working_days;
