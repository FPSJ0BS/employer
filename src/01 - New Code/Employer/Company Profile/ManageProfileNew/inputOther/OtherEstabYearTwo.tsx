...
export const OtherEstabYearTwo = () => {
  ...
  useEffect(() => {
    if (employerManageProfileFields?.establish_year) {
      setInputValue(employerManageProfileFields?.establish_year);
    }
  }, [employerManageProfileFields?.establish_year]);
    ...
    const handleClickOutside = (e: MouseEvent) => {
      ...
      if (
        ...
        if (!isSelect) {
          ...
          const currentBrandLevel = employerManageProfileFields?.establish_year;
