...
export const OtherSalaryDayTwo = () => {
  ...
  useEffect(() => {
    if (employerManageProfileFields?.salary_day) {
      setInputValue(employerManageProfileFields?.salary_day);
    }

  }, [employerManageProfileFields?.salary_day]);
    ...
    const handleClickOutside = (e: MouseEvent) => {
      ...
      if (
        ...
        if (!isSelect) {
          ...
          const currentBrandLevel = employerManageProfileFields?.salary_day;
