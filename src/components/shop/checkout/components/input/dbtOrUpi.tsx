...
export const DbtOrUpi = ({upiOrDbtinput, setUpiOrDbtinput}) => {
  ...
  const allJobTypes = ["UPI", "Direct Bank Transfer"];
  ...
  return (
    <div className=" relative  sm:w-[50%] w-[250px] ">
